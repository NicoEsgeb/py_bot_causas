...
#EXCEL_FILE_NAME = "//DESKTOP-E3HRBD4/Compartidas/Itau_cpago_gtia_estatal/ArchivoInput/Estado Escritos Marzo 2025.xlsx"

EXCEL_FILE_NAME = "C:\\Applications\\RPA 01 - INGRESO DE ESCRITOS DE PAGO GARANTIA ESTATAL EN PODER JUDICIAL\\input\\CPago_96 - sin trib 22.xlsx"
...
ESCRITOS_DCP_PATH = "C:\\Applications\\RPA 01 - INGRESO DE ESCRITOS DE PAGO GARANTIA ESTATAL EN PODER JUDICIAL\\input\\documentos"
ROLES_DONE = []
...
def RPA_01_Ingreso():
    ...
    try:
        ...
        page.locator("#inputPassword2C").fill("Picarte1215+")
...
def RPA_01_Compare_results():
    ...
    try:
        ...
        driver.find_element(By.ID, value='inputPassword2C').send_keys('Picarte1215+')
